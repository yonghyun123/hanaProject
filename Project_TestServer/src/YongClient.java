	...
	public void recieveMessage() {
		while (running) {
			...
			try {
				...
				System.out.println("[Debug] : 클라이언트로부터 수신 데이터: " + clientMessage);
	...
	public void process(String message) {
		...
		case YongProtocol.CONNECT:
			...
			if (chatServer.isExistNickName(nickName)) {
				...
				chatServer.sendAllMessage(YongProtocol.CONNECT_RESULT + YongProtocol.DELEMETER + nickName
						+ YongProtocol.DELEMETER + "SUCCESS");
