...
public class GridBagLayoutEx02 extends Panel implements ActionListener{
	TalkFrame frame;
	...
	public GridBagLayoutEx02(TalkFrame frame){
		this.frame = frame;
		...
		//label
		receiveUserL = new Label("receiver");
		fileL = new Label("attached file");
...
//		GridBagLayoutEx02 gridPanel = new GridBagLayoutEx02();
